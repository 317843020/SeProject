...
public class upload extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SaveData2DB db2 = new SaveData2DB();
		try {
			db2.save_Selectquestion(savePath);
			db2.save_Judgequestion(savePath);
		...
		request.getRequestDispatcher("/adupload.html").forward(request, response);
	}
